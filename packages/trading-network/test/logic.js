...
describe('#'+NS, function() {
    ...
    before(function() {
        ...
        .then(function() {
            ...
            return businessNetworkConnection.connect('defaultProfile', 'sample-network', 'admin', 'Xurw3yU9zI0l');
        });
    });
    ...
    describe('ChangeAssetValue()', function() {
        ...
        it('should change the value property of Asset to newValue', () => {
            ...
            // create a user
            let user = factory.newResource(NS, 'User', 'Hyperledger Composer');
